...
class GpioMqtt():
    ...
    def __init__(self):
        ...
        # self.statusRooms = [LED(26), LED(19), LED(13), LED(6), LED(5), LED(21), LED(20), LED(16), LED(12), LED(25)]
        ...
        # self.subscriber = Subscriber("192.168.1.230", self.statusRGBLED, self.statusRooms)
